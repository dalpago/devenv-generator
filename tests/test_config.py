...
class TestConfigShow:
    ...
    def test_config_show_with_env_vars(self, runner: CliRunner, tmp_path: Path) -> None:
    ...
    def test_config_show_shows_config_path(self, runner: CliRunner, tmp_path: Path) -> None:
...
class TestConfigSetRegistry:
    ...
    def test_set_registry_creates_config_file(self, runner: CliRunner, tmp_path: Path) -> None:
    ...
    def test_set_registry_with_custom_url(self, runner: CliRunner, tmp_path: Path) -> None:
    ...
    def test_set_registry_with_stored_credentials(self, runner: CliRunner, tmp_path: Path) -> None:
    ...
    def test_set_registry_with_auto_push(self, runner: CliRunner, tmp_path: Path) -> None:
